...
const ORDER_STATUS_BY_SERVICE = {
  ...
  modeling: ["Ожидает оценки", "Согласование", "ТЗ утверждено", "В работе", "Готов Черновик", "Правки", "Модель готова", "Отправлен", "Завершен"],
  scan: ["Ожидает оценки", "Ожидание звонка", "Ожидание посылки", "Посылка в пути", "Модель получена", "Сканирование", "Печать", "Модель готова", "Отправлен", "Завершен"],
};
